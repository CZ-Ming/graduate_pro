...
public:
    ...
    void setupUi(QDialog *UiLogin)
    {
        ...
        login->setGeometry(QRect(450, 290, 80, 80));
        ...
        ncl->setGeometry(QRect(450, 370, 80, 80));
    ...
    {
        UiLogin->setWindowTitle(QCoreApplication::translate("UiLogin", "\350\264\252\347\216\251\350\223\235\346\234\210", nullptr));
        n7->setText(QString());
        n2->setText(QString());
        n6->setText(QString());
        n4->setText(QString());
