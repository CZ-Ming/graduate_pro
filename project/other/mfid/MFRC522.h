...
#define M_CS(x)  	gpio_set_value(PAD_GPIO_C+30,(x))
#define M_SCK(x)    gpio_set_value(PAD_GPIO_C+29,(x))
#define M_MOSI(x)   gpio_set_value(PAD_GPIO_C+31,(x))
#define M_RST(x)    gpio_set_value(PAD_GPIO_C+7,(x))
#define M_MISO()    gpio_get_value(PAD_GPIO_D+0)
